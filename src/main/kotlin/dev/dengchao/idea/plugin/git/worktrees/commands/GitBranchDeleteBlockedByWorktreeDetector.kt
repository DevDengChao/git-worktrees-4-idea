...
class GitBranchDeleteBlockedByWorktreeDetector : GitLineEventDetector {
    private val pattern = Pattern.compile("error:\\s*[Cc]annot delete branch\\s*'(.+)'\\s*(?:checked out|used by worktree) at\\s*'(.+)'")
